...
#     def get_by_material_id(self, material_id, skip: int = 0, limit: int = 100) -> List[MaterialChunk]:
#         return self.db.query(MaterialChunk).filter(MaterialChunk.material_id == material_id).offset(skip).limit(limit).all()
